...
impl PrctlCmd {
    fn from_args(option: i32, arg2: u64, arg3: u64, arg4: u64, arg5: u64) -> Result<PrctlCmd> {
        match option {
            ...
            PR_SET_NO_NEW_PRIVS if arg2 == 1 && arg3 == 0 && arg4 == 0 && arg5 == 0 => {
                Ok(PrctlCmd::PR_SET_NO_NEW_PRIVS)
            }
            PR_GET_NO_NEW_PRIVS if arg2 == 0 && arg3 == 0 && arg4 == 0 && arg5 == 0 => {
                Ok(PrctlCmd::PR_GET_NO_NEW_PRIVS)
            }
            PR_SET_NO_NEW_PRIVS | PR_GET_NO_NEW_PRIVS => {
                return_errno_with_message!(Errno::EINVAL, "invalid no-new-privileges arguments");
            }
            _ => {
